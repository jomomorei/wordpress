    ...
    cwp_window.on("load", function() {
        ...
        if( typeof $.fn.theiaStickySidebar !== 'undefined' ){
            if( cwp_body.hasClass( 'add-sticky-sidebar') ){
                $('.cwp-main-content, .cwp-primary-sidebar, .cwp-secondary-sidebar').theiaStickySidebar();
            }
        }
        ...
        cwp_document.on('click','#search-icon',function(){
        ...
        //Global Close Button
        cwp_document.on('click','.cwp-close-btn',function(){
        ...
        cwp_document.on('click','.cwp-menu-icon-btn',function(e){
