                                ...
                                <div class="cwp-card">
                                    ...
                                    <div class="cwp-card-body">
                                        ...
                                        <ul class="cwp-personal-detail">
                                            <li class="">
                                                <span class="dashicons dashicons-smartphone"></span> <b><?php esc_html_e( 'Support:', 'cosmoswp' )?> </b><a href="https://www.cosmoswp.com/support-tickets/" target="_blank"><?php esc_html_e( 'Create A Ticket', 'cosmoswp' )?></a>
                                            </li>
                                            <li class="mt-2">
                                        ...
                                        <ul class="cwp-social">
                                            ...
                                            <li>
                                                <a href="https://twitter.com/CosmosWordPress" target="_blank">
                                   ...
                                   <div class="cwp-card">
                                    ...
                                    <div class="cwp-card-body">
                                       <p>
                                        ...
                                        <a href="https://www.cosmoswp.com/support-tickets/" target="_blank" class="cwp-btn cwp-btn-primary"><?php esc_html_e( 'Create A Ticket', 'cosmoswp' )?></a>
                                    </div>
                                </div>
                               </div>
                               <div class="grid-lg-3 grid-md-6">
                                   <div class="cwp-card">
                                    ...
                                    <div class="cwp-card-body">
                                       ...
                                       <a href="#" class="cwp-btn cwp-btn-primary"><?php esc_html_e( 'View Video Guide', 'cosmoswp' )?></a>
                                    </div>
                                </div>
                               </div>
                           </div>
                                    ...
                                    <div class="cwp-card-body">
                                        ...
                                        <ul class="cwp-table-list">
                                            ...
                                            foreach ( $more_setting as $key => $setting ){
                                                ...
                                                echo "</span>";
                                                echo "<a href='".esc_url($setting['url'])."' class='cwp-btn cwp-btn-primary'>";
