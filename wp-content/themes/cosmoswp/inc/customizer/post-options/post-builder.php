...
if (!class_exists('CosmosWP_Post_Builder')) :
    ...
    class CosmosWP_Post_Builder {
        ...
        public function display_post($post_id) {
            ...
            <div class="cwp-page cwp-single-post cwp-content-wrapper <?php echo esc_attr('cwp-'.$sidebar) ?> <?php cosmoswp_post_main_wrap_classes(); ?>" id="cwp-blog-main-content-wrapper">
                <?php
