						...
						foreach ( $fields as $key => $field ) {
                            ...
                            <div class="single-field type-<?php echo esc_attr( $field['type'] ) . ' ' . $class; ?>">
								...
								switch ( $field['type'] ) {
									...
									case 'color':
										echo '<div class="customize-control-alpha-color"><input class="alpha-color-control" data-default="' . esc_attr( $default ) . '" data-single-name="' . esc_attr( $key ) . '" type="text" value="' . esc_attr( $new_value ) . '"/></div>';
										break;
