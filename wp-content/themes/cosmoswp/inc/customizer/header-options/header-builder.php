    ...
    class CosmosWP_Header_Builder {
        ...
        public function customize_register($wp_customize) {
            ...
            $wp_customize->add_setting(cosmoswp_header_builder()->builder_section_controller, array(
                ...
                'sanitize_callback' => 'customizer_builder_sanitize_field',
	    ...
	    public function header_outside() {
		    ...
		    if (cosmoswp_is_active_header()) {
			    ...
			    ?>
                <div class="cwp-header-menu-sidebar <?php echo esc_attr(cosmoswp_string_concator($menu_display_style, $icon_spacer ,$menu_icon_align)); ?>">
                    <div class="cwp-close-btn-box">
                        <span class="cwp-close-btn"><?php echo $icon_structure ?></span>
                    </div>
				    <?php
					    ...
					    if (is_array($sidebar_element)) {
						    foreach ($sidebar_element as $key) {
							    if (isset($key['id']) && !empty($key['id'])) {
								    if (file_exists(trailingslashit(get_template_directory()) . 'template-parts/header/' . $key['id'] . '.php')) {
									    get_template_part('template-parts/header/' . $key['id']);
								    } else {
									    echo esc_html__('Create New File ', 'cosmoswp') . 'template-parts/header/' . $key['id'] . '.php';
								    }
							    }
						    }
					    }
