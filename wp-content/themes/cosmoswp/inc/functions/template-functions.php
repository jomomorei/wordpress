...
if (!function_exists('cosmoswp_sidebar_template')) {
    ...
    function cosmoswp_sidebar_template( $sidebar, $front = 'blog' ) {
        ...
        switch ($sidebar):
            case 'ful-ct':
                echo '<div class="cwp-grid-column grid-md-12">';
                get_template_part($content);
                echo '</div>';
                break;

            case 'middle-ct':
                echo '<div class="cwp-grid-column grid-md-8 offset-md-2">';
                get_template_part($content);
                echo '</div>';
                break;

            case 'ps-ct':
                echo '<div class="cwp-grid-column grid-md-3">';
                get_template_part($primary);
                echo '</div>';
                echo '<div class="cwp-grid-column grid-md-9">';
                get_template_part($content);
                echo '</div>';
                break;
            ...
            case 'ss-ct-ps':
                ...
                echo '</div>';
                echo '<div class="cwp-grid-column grid-md-6">';
                get_template_part($content);
                echo '</div>';
                echo '<div class="cwp-grid-column grid-md-3">';
                get_template_part($primary);
