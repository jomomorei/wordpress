...
if (!function_exists('cosmoswp_scripts')) {
	...
	function cosmoswp_scripts() {
		...
		wp_enqueue_style('cosmoswp-style', COSMOSWP_URL . '/style' . COSMOSWP_SCRIPT_PREFIX . '.css', array(), '1.0.0');
		...
		/*theme custom js*/
		wp_enqueue_script('cosmoswp-custom', COSMOSWP_URL . '/assets/js/cosmoswp' . COSMOSWP_SCRIPT_PREFIX . '.js', apply_filters('cosmoswp_js_dep',array('jquery')), '1.0.0', true );
...
if (!function_exists('cosmoswp_admin_scripts')) {
    ...
    function cosmoswp_admin_scripts($hook) {
	    ...
	    if ('widgets.php' == $hook || cosmoswp_is_edit_page()) {
		    ...
		    wp_enqueue_script('cosmoswp-admin', COSMOSWP_URL . '/assets/js/cosmoswp-admin' . COSMOSWP_SCRIPT_PREFIX . '.js', '', '1.1.0', true );
        }
